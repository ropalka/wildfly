...
public class UndertowConnectorTestCase {
    ...
    public void getType() {
        ...
        assertSame(Connector.Type.AJP, new UndertowConnector(new AjpListenerService(null, "", "", options, OptionMap.EMPTY)).getType());
        assertSame(Connector.Type.HTTP, new UndertowConnector(new HttpListenerService(null, "", "", options, OptionMap.EMPTY, false, false, false)).getType());
        assertSame(Connector.Type.HTTPS, new UndertowConnector(new HttpsListenerService(null, "", "", options, null, OptionMap.EMPTY, false)).getType());
    }
